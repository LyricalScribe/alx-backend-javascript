...
<<<<<<< HEAD
  (_fs || _load_fs()).default.existsSync(filePath) &&
  !(_fs || _load_fs()).default.lstatSync(filePath).isDirectory();

exports.default = (pathToResolve, cwd) => {
  if (!(_path || _load_path()).default.isAbsolute(cwd)) {
    throw new Error(`"cwd" must be an absolute path. cwd: ${cwd}`);
  }
  const absolutePath = (_path || _load_path()).default.isAbsolute(pathToResolve)
    ? pathToResolve
    : (_path || _load_path()).default.resolve(cwd, pathToResolve);
...
const resolveConfigPathByTraversing = (pathToResolve, initialPath, cwd) => {
  const jestConfig = (_path || _load_path()).default.resolve(
    pathToResolve,
  ...
  const packageJson = (_path || _load_path()).default.resolve(
    pathToResolve,
  ...
  if (
    pathToResolve === (_path || _load_path()).default.dirname(pathToResolve)
  ) {
=======
...
>>>>>>> 74277b58428b76b5d4577f14d767a83dccdacaf2
  ...
  return resolveConfigPathByTraversing(
<<<<<<< HEAD
    (_path || _load_path()).default.dirname(pathToResolve),
=======
